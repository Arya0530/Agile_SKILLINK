...
class PostController extends Controller
{
    ...
    // GET /api/posts
    // Filter: ?tag=Flutter  &  ?post_type=Kolaborasi Lomba
    // ============================================================
    ...
    // Filter: ?tag=Flutter  &  ?post_type=Kolaborasi Startup
    // ============================================================
    ...
    public function completeProject(Request $request, $id)
    {
        ...
        $projectTitle = mb_substr($post->content, 0, 200);
    ...
    public function apply(Request $request, $id)
    {
        ...
        $alreadyApplied = $request->user()->applications()->where('post_id', $id)->exists();
        if ($alreadyApplied) {
            return response()->json(['success' => false, 'message' => 'Kamu sudah pernah apply ke postingan ini!'], 400);
        }
